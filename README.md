...
```
yarn add --dev @diotoborg/ab-harum
```

or

```
npm install --save-dev @diotoborg/ab-harum
```
...
```js
const TsconfigPathsPlugin = require('@diotoborg/ab-harum');
...
**Notice that the plugin is placed in the `resolve.plugins` section of the configuration.** `@diotoborg/ab-harum` is a resolve plugin and should only be placed in this part of the configuration. Don't confuse this with the plugins array at the root of the webpack configuration object.
...
```ts
import TsconfigPathsPlugin from "@diotoborg/ab-harum";
```
...
[version-image]: https://img.shields.io/npm/v/@diotoborg/ab-harum.svg?style=flat
[version-url]: https://www.npmjs.com/package/@diotoborg/ab-harum
[build-image]: https://github.com/diotoborg/ab-harum/workflows/Build/badge.svg
[build-url]: https://github.com/diotoborg/ab-harum/actions?query=workflow%3ABuild+branch%3Amaster
[codecov-image]: https://codecov.io/gh/dividab/@diotoborg/ab-harum/branch/master/graph/badge.svg
[codecov-url]: https://codecov.io/gh/dividab/@diotoborg/ab-harum
[prettier-image]: https://img.shields.io/badge/code_style-prettier-ff69b4.svg?style=flat
[prettier-url]: https://github.com/prettier/prettier
[license-image]: https://img.shields.io/github/license/jonaskello/@diotoborg/ab-harum.svg?style=flat
